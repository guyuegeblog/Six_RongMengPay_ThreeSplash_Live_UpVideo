...
import com.app.Adapter.Jar_MultiAdapter;
...
public class JarpanFragment extends LazyFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private Jar_MultiAdapter jar_multiAdapter;
    ...
    protected void onCreateViewLazy(Bundle savedInstanceState) {
        ...
        rootView = LayoutInflater.from(mContext).inflate(R.layout.fragment_jarpan, null);
    ...
    private void initView() {
        ...
        jarpanseSwipeFresh.setRefreshing(false);
        jarpanseRecyclerview.addItemDecoration(new Level_MarginDecoration(mContext));
        jarpanseRecyclerview.setHasFixedSize(true);
        jarpanseRecyclerview.setLayoutManager(new GridLayoutManager(mContext, 2));
        jar_multiAdapter = new Jar_MultiAdapter(jarpanse_Multi, mContext);
