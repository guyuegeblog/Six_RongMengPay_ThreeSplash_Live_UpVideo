 ...
 */
public class HanziToPinyinTool {

    private static final boolean DEBUG = true;
    private static final String TAG = "Hanzi";
    ...
    private static HanziToPinyinTool sInstance;
    ...
    protected HanziToPinyinTool(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static HanziToPinyinTool getInstance() {
        synchronized (HanziToPinyinTool.class) {
            if (sInstance != null) {
                return sInstance;
            }
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA)) {
                    sInstance = new HanziToPinyinTool(true);
                    return sInstance;
                }
            }
            if (DEBUG) {
                Log.w(TAG, "There is no Chinese collator, Hanzi is disabled");
            }
            sInstance = new HanziToPinyinTool(false);
            return sInstance;
        }
    }
