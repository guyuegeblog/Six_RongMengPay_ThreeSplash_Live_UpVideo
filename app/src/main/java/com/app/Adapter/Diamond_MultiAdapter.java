 ...
 */
public class Diamond_MultiAdapter extends BaseMultiItemQuickAdapter<Multi, BaseViewHolder> {

    private MainActivity mContext;

    public Diamond_MultiAdapter(List<Multi> data, MainActivity mContext) {
        super(data);
    ...
    public void doPlay(ComprehenSiveInfo channeLnfo) {
        ...
        if (vipType == Multi.VIP_DIAMOND_TYPE || vipType == Multi.VIP_RED_DIAMOND_TYPE || vipType == Multi.VIP_CROWN_TYPE) {
            ...
            Log.i("videoStr", "钻石 " + channeLnfo.getAddress_hd());
