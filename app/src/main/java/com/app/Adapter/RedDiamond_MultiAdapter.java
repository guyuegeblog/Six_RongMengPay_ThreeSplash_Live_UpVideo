 ...
 */
public class RedDiamond_MultiAdapter extends BaseMultiItemQuickAdapter<Multi, BaseViewHolder> {

    private MainActivity mContext;

    public RedDiamond_MultiAdapter(List<Multi> data, MainActivity mContext) {
        super(data);
