...
public class BarrageView extends RelativeLayout {
    ...
    private static final long BARRAGE_GAP_MAX_DURATION = 3500;//两个弹幕的最大间隔时间
    private int maxSpeed = 15000;//速度，ms
...
//        itemText.add("希望可以支持下载到手机，家里没有wifi。想看的时候看不了。");
    ...
    private void generateItem() {
        try {
            ...
            com.app.View.BarrageItem item = new com.app.View.BarrageItem();
            String tx;
            try {
    ...
    public void initBarrageItem(com.app.View.BarrageItem item, String tx) {
        try {
            showList.add(tx);
...
//        itemList.add(item);
    ...
    private void showBarrageItem(final com.app.View.BarrageItem item) {
    ...
    private TranslateAnimation generateTranslateAnim(com.app.View.BarrageItem item, int leftMargin) {
     ...
     */
    public float getTextWidth(com.app.View.BarrageItem item, String text, float Size) {
    ...
    private int getLineHeight() {
        Rect bounds = new Rect();
        try {
            com.app.View.BarrageItem item = new BarrageItem();
